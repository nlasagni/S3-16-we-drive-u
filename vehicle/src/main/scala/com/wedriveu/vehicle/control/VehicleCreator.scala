...
class VehicleCreator(speed: Double,
  ...
  override def run(): Unit = {
    ...
    //TODO
    Log.info(this.getClass.getSimpleName, "Random license plate: " + randomPlate)

    val initialState: String = ""
    val initialPosition: Position = new Position(VehicleConstants.initialLatitude, VehicleConstants.initialLongitude)
    val vertx: Vertx = Vertx.vertx()

    val imageList: Array[String] = Array("http://static.allaguida.it/r/843x0/www.allaguida.it/img/Fiat-500.jpg",
    ...
    val descriptions: Array[String] = Array("Fiat 500, colore bianco, tre porte, quattro sedili, motore a metano.",
